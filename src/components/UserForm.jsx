    ...
    <div className="form-container">
      ...
      <form onSubmit={submitForm}>
        ...
        {!sumbissionStatus ? (
          <button
            type="submit"
            className="flex my-5 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm sm:flex my-5 w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 m-auto"
          >
            {" "}
